...
namespace leave_management.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public IGenericRepository<LeaveType> LeaveTypes =>
             _leaveTypes == null ? _leaveTypes : new GenericRepository<LeaveType>(_context);
             
        public IGenericRepository<LeaveRequest> LeaveRequests =>
            _leaveRequests == null ? _leaveRequests : new GenericRepository<LeaveRequest>(_context);
        public IGenericRepository<LeaveAllocation> LeaveAllocations =>
            _leaveAllocations == null ? _leaveAllocations : new GenericRepository<LeaveAllocation>(_context);
